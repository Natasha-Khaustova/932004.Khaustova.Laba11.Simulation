...
namespace Lab8_3
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double MathExpectation = Average / 5;
            double Variance = 0;
            for (int i = 0; i < 5; i++)
            {
                Variance += ((Generation[i] - MathExpectation) * (Generation[i] - MathExpectation))*Generation[i];
            }
            ...
            vibSredLbl.Text = Math.Round(MathExpectation, 4).ToString();
